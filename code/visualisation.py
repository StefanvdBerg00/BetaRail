...
def visualisation(connections, quality):
    ...
    for connection in connections:
        ...
        plt.scatter([connection.city1.y, connection.city2.y], [connection.city1.x, connection.city2.x], color="blue", zorder=2)
        mplcursors.cursor(plt.scatter([connection.city1.y, connection.city2.y], [connection.city1.x, connection.city2.x], color="blue", zorder=2))
